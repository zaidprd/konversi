...
import {
  ...
  Award, Mail, Repeat2, Crown, Check, X as XIcon, Shield, Zap,
  Globe, FileCheck, Heart, Clock, Megaphone, ArrowRight,
} from 'lucide-react';
...
const LandingPage = ({ onSelectTool }) => {
  ...
  // Tabel perbandingan SEO: KONVERSI vs Smallpdf vs iLovePDF
  const compareRows = [
    { feature: '100% proses lokal di browser (privasi penuh)', us: true, small: false, love: false },
    { feature: 'Tanpa upload file ke server', us: true, small: false, love: false },
    { feature: 'Gratis tanpa batas ukuran file', us: true, small: false, love: false },
    { feature: 'Tanpa watermark di hasil', us: true, small: true, love: false },
    { feature: 'Tanpa daftar akun', us: true, small: false, love: false },
    { feature: 'Perbandingan ukuran file Before vs After', us: true, small: false, love: false },
    { feature: 'Slider kualitas ala Squoosh', us: true, small: false, love: false },
    { feature: 'Paket Pro tanpa iklan + batch 100 file', us: true, small: true, love: true },
    { feature: 'Bahasa Indonesia default', us: true, small: false, love: false },
  ];
  ...
  const faqs = [
    ...
    {
      q: `Apa bedanya ${BRAND.name} dengan iLovePDF & Smallpdf?`,
      a: `${BRAND.name} memproses file Anda 100% di browser - tidak ada upload ke server cloud. Berbeda dengan iLovePDF & Smallpdf yang mengirim file ke server mereka, ${BRAND.name} lebih privat, lebih cepat, dan tidak ada risiko kebocoran data.`,
    },
    {
      q: 'Apakah file saya aman dan privat?',
      a: `Sangat aman. Semua konversi dilakukan secara lokal di memori browser Anda menggunakan javascript. File tidak pernah meninggalkan perangkat Anda, sehingga tidak ada pihak ketiga yang bisa melihat isinya.`,
    },
    {
    ...
    {
      q: `Bagaimana cara berlangganan ${BRAND.name} Pro?`,
      a: `Klik tombol "Coba Pro" di header. Pro menghapus semua iklan, membuka batch processing sampai 100 file sekaligus, akses API, dan dukungan prioritas. Hanya ${PRO_PLAN.price}.`,
    },
  ];
  ...
  return (
    <div className="animate-fadeIn">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-slate-600 text-base md:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Alternatif <strong>iLovePDF</strong> & <strong>Smallpdf</strong> yang memproses
                file langsung di browser Anda. Lebih cepat, lebih privat, 100% gratis.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                >
                  <span>Bandingkan dengan iLovePDF</span>
                </a>
              </div>
            ...
            {/* Hero visual: live comparison mock */}
      ...
      {/* TRUST BAR - thin strip with trust signals */}
      ...
      {/* TOOLS SECTION - clean grid with search */}
      ...
      {/* COMPARISON - KONVERSI vs Smallpdf vs iLovePDF (SEO + trust) */}
      <section id="bandingkan" className="py-16 md:py-20 bg-slate-50 border-y border-slate-200 scroll-mt-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 space-y-3">
            <div className="inline-flex items-center space-x-1 bg-indigo-50 text-indigo-700 text-xs font-semibold px-3 py-1 rounded-full border border-indigo-100">
              <Award size={12} />
              <span>Perbandingan Transparan</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
              Kenapa Memilih {BRAND.name}?
            </h2>
            <p className="text-slate-600 text-sm md:text-base max-w-2xl mx-auto">
              Tabel di bawah menunjukkan perbedaan fitur utama antara {BRAND.name},
              iLovePDF, dan Smallpdf - apa yang Anda dapatkan, apa yang tidak.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    <th className="text-left font-semibold text-slate-500 px-5 py-4 text-xs uppercase tracking-wider">
                      Fitur
                    </th>
                    <th className="px-4 py-4 text-center">
                      <div className="inline-flex flex-col items-center">
                        <span className="font-black text-slate-900 text-base">{BRAND.name}</span>
                        <span className="text-[10px] text-rose-600 font-semibold uppercase tracking-wider">Direkomendasikan</span>
                      </div>
                    </th>
                    <th className="px-4 py-4 text-center font-semibold text-slate-500">Smallpdf</th>
                    <th className="px-4 py-4 text-center font-semibold text-slate-500">iLovePDF</th>
                  </tr>
                </thead>
                <tbody>
                  {compareRows.map((row, i) => (
                    <tr
                      ...
                      className={`border-b border-slate-100 last:border-0 ${
                        row.us && !row.small && !row.love ? 'bg-rose-50/40' : ''
                      }`}
                    >
                      ...
                      <td className="px-4 py-3.5 text-center">
                        {row.us ? (
                          ...
                          <XIcon size={18} className="text-slate-300 inline" />
                        )}
                      </td>
                      <td className="px-4 py-3.5 text-center">
                        {row.small ? (
            ...
            <div className="bg-slate-50 border-t border-slate-200 px-5 py-3 text-[11px] text-slate-500">
              Perbandingan berdasarkan fitur publik di situs resmi Smallpdf.com dan iLovePDF.com per 2025.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { n: 2, title: 'Upload File', desc: 'Drag & drop file Anda ke area upload. Atur opsi jika perlu.' },
      ...
      {/* PRO SECTION - compact, single row */}
      ...
      {/* FINAL CTA + AD PLACEHOLDER STRIP */}
